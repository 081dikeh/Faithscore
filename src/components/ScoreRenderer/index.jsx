                ...
                if (kc) {
                  ...
                  if (pivot) {
                    elems.push(
                      <text
                        key={`pivot-${ev.id}`}
                        x={noteCX - NOTE_SZ * 0.5}
                        y={rowY - NOTE_SZ * 0.75}
                        textAnchor="middle"
                        fontFamily={FONT}
                        fontSize={Math.max(7, NOTE_SZ * 0.5)}
                        fontWeight={900}
                  ...
                  // (not pinned to the system's top margin, which left a
                  // big gap whenever the top voice's row sat well below
                  // that margin already).
                  if (pIdx === 0) {
                    elems.push(
                      <text
