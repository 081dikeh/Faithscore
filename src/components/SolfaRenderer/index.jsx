          ...
          try {
            ...
            try {
              renderSeq.forEach((seqNote, ni) => {
                ...
                const STACK_GAP = 17; // vertical spacing between stacked marks
                ...
                marks.forEach((art, markIndex) => {
                  ...
                  if (art === "staccato") {
                    ctx.beginPath();
                    ctx.arc(nx, ay, 3.5, 0, Math.PI * 2);
                    ctx.fill();
                  } else if (art === "tenuto") {
                    ctx.fillRect(nx - 7, ay, 14, 3);
                  } else if (art === "accent") {
                    ctx.font = "bold 19px serif";
                    ctx.fillText(">", nx - 7, ay + 5);
                  } else if (art === "marcato") {
                    ctx.font = "bold 17px serif";
                    ctx.fillText("^", nx - 5, ay + 2);
                  } else if (art === "fermata") {
                    ctx.font = "bold 21px serif";
                    ctx.fillText("𝄐", nx - 7, ay + 2);
                  } else if (art === "trill") {
                    ctx.font = "italic bold 15px serif";
                    ctx.fillText("tr", nx - 5, ay + 2);
                  } else if (art === "mordent") {
                    ctx.font = "bold 17px serif";
                    ctx.fillText("𝆁", nx - 5, ay + 2);
                  } else if (art === "turn") {
                    ctx.font = "bold 17px serif";
                    ctx.fillText("𝆃", nx - 5, ay + 2);
  ...
  return (
    ...
    >
      ...
      {hairpins.map((hp) => {
        ...
        const y = z1.y - 28; // clearly above the staff, matching dynamics
        const mid = 6;
      ...
      {octaveLines.map((ol) => {
        ...
        const y = isAbove ? z1.y - 22 : z1.y + z1.height + 4;
